...
struct poi_t_struct *search_by_name(struct poi_t_struct*);
...
void remove_by_ID(struct poi_t_struct**, struct poi_t_struct*, long);

//maybe remove by name?

void remove_all_records(struct poi_t_struct**, struct poi_t_struct*, int);
